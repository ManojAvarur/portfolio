        ...
        <div className="bg-dark">
            <header className="sticky glass-effect bg-white/1 inset-x-0 top-0 z-50">
                <nav aria-label="Global" className="flex items-center justify-between  lg:px-8">
                    ...
                    <div className="hidden w-full lg:flex items-center justify-center gap-x-30">
                        <a href="#" className="text-2xl font-semibold text-nyanza hover:cursor-pointer hover-underline-animation">
                            About
                        </a>
                        <a href="#" className="text-2xl font-semibold text-nyanza hover:cursor-pointer hover-underline-animation">
                            experience
