    ...
    return (
        <>
            <div className="max-h-screen overflow-hidden [--rotate:50deg] sm:[--rotate:70deg]">
                ...
                <div className={"absolute animate-slide-in glass-effect rounded-2xl top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[90%] md:w-[80%] lg:w-[65%] " + styles['main-content']}>
                    <p className="text-xl md:text-4xl 2xl:text-6xl text-left font-bold italic text-raisin-black m-2.5 font-[IndieFlower] over">
